	...
	public static function woocommerce_inactive_notice() {
		if ( current_user_can( 'activate_plugins' ) ) :
			if ( ! is_woocommerce_active() ) : ?>
				...
				<div id="message" class="error">
					<p><?php printf( __( '%1$sRegistrations for WooCommerce is inactive.%2$s This version of Registrations requires WooCommerce 2.1 or newer. Please %3$supdate WooCommerce to version 2.1 or newer%4$s', 'registrations-for-woocommerce' ), '<strong>', '</strong>', '<a href="' . admin_url( 'plugin-install.php?s=WooCommerce&tab=search&type=term' ) . '">', '&nbsp;&raquo;</a>' ); ?></p>
				</div>
			<?php endif; ?>
			<?php
		endif;
